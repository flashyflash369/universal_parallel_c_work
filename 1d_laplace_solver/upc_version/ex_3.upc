...
int main(int argc, char **argv){
    ...
    upc_barrier; //Prevent race condition
...
To remove the race condition, I should use the construct upc_barrier so that all threads
reach the same point before the result is printed by thread 0
*/
